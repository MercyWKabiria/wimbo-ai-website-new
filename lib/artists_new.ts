...
export const artists: Artist[] = [
  {
    ...
    vocalRangeMap: {
      ...
      powerZone: { note: 'G4', description: 'Full voice, maximum projection. This is where Kito is loudest and most commanding — the natural home of anthemic worship choruses and declarative praise hooks.', score: 9.0 },
  ...
  },
  {
    ...
    vocalRangeMap: {
      upperLimit: { note: 'B4', description: 'Jake\'s ceiling — emotional rather than powerful. Reserved for vulnerable peaks where the song reaches its most honest moments. Use with intention.', score: 7.0 },
  ...
  },
  {
    ...
    genreBreakdown: [
      ...
      { title: 'Afro-Urban', description: "Urban Afro-beat production allows his delivery to ride groove-heavy rhythms with natural swagger. His voice carries energy and attitude that urban East African music demands, bridging clubs and streets." },
