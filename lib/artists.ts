...
export const artists: Artist[] = [
  ...
  // ==========================================
  {
    ...
    tracks: [
      { id: 1, title: '1000 Reasons', duration: '4:12', tags: ['Kito Kaya', 'Worship'] },
      { id: 2, title: 'Hosanna Hosanna', duration: '3:45', isHot: true, tags: ['Kito Kaya', 'Praise'] },
      { id: 3, title: 'Place of Prayer', duration: '3:58', tags: ['Kito Kaya', 'Worship'] },
      { id: 4, title: 'Sijui Nikutafute', duration: '4:42', isHot: true, tags: ['Kito Kaya', 'Worship'] },
    ],
    albums: [
      { title: 'My Devotion', image: '/images/album-devotion.jpg', trackCount: 4 },
    ],
  ...
  // ==========================================
  {
    ...
    category: 'praise-worship',
    tags: ['Tenor', 'Swahili', 'Worship'],
    stats: { tracksRecorded: 3, albumFeatures: 1, dialects: 2 },
    ...
    tracks: [
      { id: 1, title: 'My Song of Surrender', duration: '4:35', tags: ['Jiroh Malaka', 'Devotional'] },
      { id: 2, title: 'Nipe Macho', duration: '4:22', tags: ['Jiroh Malaka', 'Worship'] },
      { id: 3, title: 'Unbound', duration: '4:08', isHot: true, tags: ['Jiroh Malaka', 'Worship'] },
    ],
    albums: [
      { title: 'My Devotion', image: '/images/album-devotion.jpg', trackCount: 3 },
    ],
  ...
  // ==========================================
  {
    ...
    tracks: [
      { id: 1, title: 'My God Will Supply', duration: '4:18', isHot: true, tags: ['Maya Lowi', 'Gospel'] },
    ],
    albums: [
      { title: 'My Devotion', image: '/images/album-devotion.jpg', trackCount: 1 },
    ],
  ...
  // ==========================================
  {
    ...
    tracks: [
      { id: 1, title: 'Najipa Tu', duration: '4:08', tags: ['Lenase Tendi', 'Afro-Soul'] },
      { id: 2, title: 'Nitangoja Nikupate', duration: '4:22', isHot: true, tags: ['Lenase Tendi', 'Afro-Soul'] },
      { id: 3, title: 'Staki Mambo Mengi', duration: '3:38', tags: ['Lenase Tendi', 'Alpha Mtaa', 'Urban'] },
    ],
    albums: [
      { title: 'Of Love & Comebacks', image: '/images/album-love.jpg', trackCount: 3 },
    ],
  ...
  // ==========================================
  {
    ...
    tracks: [
      { id: 1, title: 'Don\'t Cry For Me', duration: '4:12', tags: ['Avel Niri', 'R&B'] },
      { id: 2, title: 'Hopeless Romantic', duration: '3:42', isHot: true, tags: ['Avel Niri', 'Afro-Soul'] },
      { id: 3, title: 'Sina Hiyo Time', duration: '3:42', tags: ['Avel Niri', 'Jael Monah', 'Afro-Pop'] },
    ],
    albums: [
      { title: 'Of Love & Comebacks', image: '/images/album-love.jpg', trackCount: 3 },
    ],
  ...
  // ==========================================
  {
    ...
    stats: { tracksRecorded: 1, albumFeatures: 1, dialects: 2 },
    ...
    tracks: [
      { id: 1, title: 'Boomerang', duration: '3:15', isHot: true, tags: ['Jena Mpito', 'Alpha Mtaa', 'Afro-Pop'] },
    ],
    albums: [
      { title: 'Of Love & Comebacks', image: '/images/album-love.jpg', trackCount: 1 },
    ],
  ...
  // ==========================================
  {
    ...
    category: 'heart-vibe',
    tags: ['Mezzo-Soprano', 'Swahili', 'Afro-Pop'],
    stats: { tracksRecorded: 3, albumFeatures: 2, dialects: 2 },
    vocalScores: { melodyFit: 9, vocalRange: 8, emotionalDepth: 8, dialectAccuracy: 9, phrasingDynamics: 8, marketFit: 9 },
    ...
    tracks: [
      { id: 1, title: 'Wacha Waseme', duration: '3:52', tags: ['Jael Monah', 'Gospel'] },
      { id: 2, title: 'Hatia', duration: '3:52', isHot: true, tags: ['Jael Monah', 'Afro-Pop'] },
      { id: 3, title: 'Moyo Wangu na Udunde', duration: '3:45', tags: ['Jael Monah', 'Afro-Pop'] },
    ],
    albums: [
      { title: 'My Devotion', image: '/images/album-devotion.jpg', trackCount: 1 },
      { title: 'Of Love & Comebacks', image: '/images/album-love.jpg', trackCount: 2 },
    ],
  ...
  // ==========================================
  {
    ...
    tracks: [
      { id: 1, title: 'Sema Ukweli', duration: '3:18', isHot: true, tags: ['Master Gen-tone', 'Gengetone'] },
    ],
    albums: [
      { title: 'Of Love & Comebacks', image: '/images/album-love.jpg', trackCount: 1 },
    ],
  ...
  // ==========================================
  // ARTIST 11: ZERANI AMADI (Gospel - Praise & Worship)
  // ==========================================
  {
    id: '11',
    slug: 'zerani-amadi',
    name: 'Zerani Amadi',
    tagline: 'Soulful worship vocals rooted in authentic African gospel tradition.',
    description: 'Zerani Amadi brings deep spiritual resonance and soulful delivery to contemporary East African worship.',
    longBio: "Zerani Amadi represents the soulful depth of East African gospel — a voice that carries the weight of tradition while embracing contemporary worship expression. Her rich vocal tone moves effortlessly between intimate devotional moments and powerful declarations of faith. Zerani excels in worship that feels rooted and authentic, drawing from the deep wells of African gospel heritage while speaking to modern believers. Her voice carries the kind of spiritual authority that comes from genuine faith and musical excellence combined. The voice of surrendered worship.",
    image: '/images/artist-zerani.png',
    category: 'praise-worship',
    tags: ['Alto', 'Swahili', 'Worship'],
    stats: { tracksRecorded: 1, albumFeatures: 1, dialects: 2 },
    vocalScores: { melodyFit: 9, vocalRange: 8, emotionalDepth: 9, dialectAccuracy: 9, phrasingDynamics: 8, marketFit: 8 },
    voiceProfileSummary: "Zerani Amadi represents the soulful depth of East African gospel — a voice that carries the weight of tradition while embracing contemporary worship expression. Her rich alto tone moves effortlessly between intimate devotional moments and powerful declarations of faith, creating space for genuine spiritual encounter. Zerani excels in worship that feels rooted and authentic, drawing from the deep wells of African gospel heritage while speaking clearly to modern believers seeking real connection. Her voice carries the kind of spiritual authority that comes only from genuine faith combined with musical excellence. When worship needs to feel ancient and fresh at once, Zerani delivers.",
    voiceArchitectureSummary: "Zerani's range was specifically shaped for soulful gospel production — tracks built around the G3–C4 sweet spot will sit naturally in her voice with maximum warmth and spiritual resonance. Her alto depth carries lyrics with weight and authority. Her voice is optimized for worship that prioritizes authenticity and emotional connection over technical display.",
    genreBreakdown: [
      { title: 'Contemporary Gospel', description: "Zerani's alto brings depth and warmth to contemporary gospel arrangements. Her voice grounds worship songs with spiritual authority while maintaining the accessibility that modern congregations need. She anchors productions with soulful presence." },
      { title: 'Traditional African Worship', description: "In arrangements drawing from African gospel traditions, Zerani's voice feels completely at home. Her phrasing honors the call-and-response patterns and melodic sensibilities of East African worship heritage." },
      { title: 'Gospel Soul', description: "Soul-influenced gospel production allows Zerani's voice to stretch expressively. Her rich tone carries emotional weight that connects with listeners on a deep, visceral level." },
      { title: 'Devotional Ballads', description: "Slower worship arrangements highlight Zerani's emotional depth and lyrical clarity. Her voice creates intimate spaces for reflection and surrender." },
    ],
    vocalRangeMap: {
      upperLimit: { note: 'F4', description: "Zerani's ceiling — warm and powerful. Reserved for climactic worship moments that need both strength and soul.", score: 8.0 },
      headVoice: { note: 'D4', description: "Where Zerani's voice lightens while maintaining richness. Good for expressive melodic moments.", score: 8.5 },
      powerZone: { note: 'C4', description: "Full voice, maximum warmth. This is where Zerani's worship declarations live with authority and grace.", score: 9.0 },
      sweetSpot: { note: 'A3', description: "The most natural, richest part of Zerani's range. Verses and intimate worship land here with deep authenticity.", score: 9.5 },
      midChest: { note: 'G3', description: "Deep and grounded. Works beautifully for storytelling and prayerful passages.", score: 9.0 },
      lowerLimit: { note: 'E3', description: "The foundation of Zerani's range. Rich alto depth for intimate moments and grounding.", score: 8.0 },
    },
    tracks: [
      { id: 1, title: 'Ninawachilia', duration: '4:28', isHot: true, tags: ['Zerani Amadi', 'Worship'] },
    ],
    albums: [
      { title: 'My Devotion', image: '/images/album-devotion.jpg', trackCount: 1 },
    ],
    seoDescription: 'Zerani Amadi brings soulful depth to contemporary East African gospel worship.',
    searchTags: ['gospel', 'worship', 'female alto', 'african gospel', 'soulful worship'],
  },

  // ==========================================
  // ARTIST 12: ALPHA MTAA (Urban/Rap - Heart & Vibe)
  // ==========================================
  {
    id: '12',
    slug: 'alpha-mtaa',
    name: 'Alpha Mtaa',
    tagline: 'Street-smart flows and urban energy from Nairobi\'s music scene.',
    description: 'Alpha Mtaa delivers sharp rap verses and urban hooks that capture the energy of East African street culture.',
    longBio: "Alpha Mtaa is raw Nairobi street energy channeled into precise, punchy delivery — a rapper built for features, hooks, and verses that add urban credibility to any track. His flow switches effortlessly between Sheng punchlines and melodic hooks, making him the perfect collaborator for artists who need street authenticity without losing mainstream appeal. Alpha represents the bridge between underground rap culture and commercial Afropop, bringing lyrical sharpness and rhythmic precision to every feature. The voice that adds street heat to any track.",
    image: '/images/artist-alpha.png',
    category: 'heart-vibe',
    tags: ['Rap', 'Sheng', 'Urban'],
    stats: { tracksRecorded: 3, albumFeatures: 1, dialects: 2 },
    vocalScores: { melodyFit: 7, vocalRange: 6, emotionalDepth: 7, dialectAccuracy: 10, phrasingDynamics: 9, marketFit: 8 },
    voiceProfileSummary: "Alpha Mtaa is raw Nairobi street energy channeled into precise, punchy delivery — a rapper built for features, hooks, and verses that add urban credibility to any track. His flow switches effortlessly between Sheng punchlines and melodic hooks, making him the perfect collaborator for artists who need street authenticity without losing mainstream appeal. His perfect 10 in dialect accuracy reflects Sheng mastery that cannot be faked. Alpha represents the bridge between underground rap culture and commercial Afropop, bringing lyrical sharpness and rhythmic precision to every feature he touches. When a track needs street heat, Alpha delivers.",
    voiceArchitectureSummary: "Alpha's range was specifically shaped for urban rap production — his voice prioritizes rhythmic precision and lyrical clarity over melodic range. His C4–E4 sweet spot carries maximum Sheng authenticity. His voice is optimized for features, hooks, and verses that add urban credibility to pop and Afrobeat productions.",
    genreBreakdown: [
      { title: 'Gengetone', description: "Alpha's delivery fits naturally into Gengetone production. His Sheng flow adds street authenticity and energy that defines the genre's raw appeal." },
      { title: 'Afro-Urban', description: "In urban Afropop productions, Alpha's verses add edge and credibility. His flow bridges street culture and mainstream appeal seamlessly." },
      { title: 'Hip-Hop Features', description: "Alpha excels as a featured artist on hip-hop tracks. His verses are tight, punchy, and memorable — designed to elevate any song he touches." },
      { title: 'Commercial Rap', description: "When productions need rap elements with mainstream appeal, Alpha delivers verses that hit hard without alienating pop audiences." },
    ],
    vocalRangeMap: {
      upperLimit: { note: 'G4', description: "Alpha's ceiling — used for ad-libs and hype moments that punctuate verses with energy.", score: 6.0 },
      headVoice: { note: 'F4', description: "Light and energetic — used for melodic hooks and vocal variations.", score: 6.5 },
      powerZone: { note: 'E4', description: "Where Alpha's flow hits hardest. Punchlines and key bars land here with maximum impact.", score: 8.5 },
      sweetSpot: { note: 'D4', description: "The most natural part of his range. Verses flow here with authenticity and clarity.", score: 9.0 },
      midChest: { note: 'C4', description: "Rhythmic and controlled. Works well for storytelling verses and laid-back flows.", score: 8.5 },
      lowerLimit: { note: 'A3', description: "The foundation — deep and grounded for bass-heavy moments and spoken intros.", score: 7.5 },
    },
    tracks: [
      { id: 1, title: 'Boomerang', duration: '3:15', isHot: true, tags: ['Alpha Mtaa', 'Jena Mpito', 'Afro-Pop'] },
      { id: 2, title: 'Sina Hiyo Time', duration: '3:42', tags: ['Alpha Mtaa', 'Avel Niri', 'Jael Monah'] },
      { id: 3, title: 'Staki Mambo Mengi', duration: '3:38', tags: ['Alpha Mtaa', 'Lenase Tendi', 'Urban'] },
    ],
    albums: [
      { title: 'Of Love & Comebacks', image: '/images/album-love.jpg', trackCount: 3 },
    ],
    seoDescription: 'Alpha Mtaa delivers sharp rap verses and urban energy from Nairobi streets.',
    searchTags: ['rap', 'sheng', 'urban', 'gengetone', 'nairobi hip hop'],
  },
]
